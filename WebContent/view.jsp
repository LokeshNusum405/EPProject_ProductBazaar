...
<body>
                    ...
                    <div class="user">
						...
						<div class="btn-group" role="group">
						    ...
						    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
						      <a class="dropdown-item" href="adminhome.jsp"><i class="fa fa-heart"></i> Add Products</a>
        ...
        <div class="container-fluid">
            ...
            <div class="row align-items-center product-slider product-slider-4">
                    ...
                    try {
            			...
            			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/productbazaar","root","root");
            			System.out.println("connection");
            			PreparedStatement pstmt=con.prepareStatement("select * from products where product_category='Trending'");
            					...
            					<div class="product-item">
			                        ...
			                        <div class="product-image">
			                            ...
			                            <div class="product-action">
			                                <a href="update.jsp?product_id=<%=rs.getInt(1) %>"><i class="fa fa-edit"></i></a>
			                                <a href="deleteproduct.jsp?product_id=<%=rs.getInt(1) %>"><i class="fa fa-trash"></i></a>
			                                
			                            </div>
			                        </div>
			                        <div class="product-price">
			                        <h3><span><a class="btn" href="update.jsp?product_id=<%=rs.getInt(1) %>"><i class="fa fa-edit"></i>Update</a></span></h3>
			                         <a class="btn" href="deleteproduct.jsp?product_id=<%=rs.getInt(1) %>"><i class="fa fa-trash"></i>Delete</a>
			                        </div>
			                    </div>
      						</div>
            				<%
            ...
            <div class="row align-items-center product-slider product-slider-4">
                <%
                    try {
            			...
            			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/productbazaar","root","root");
            			System.out.println("connection");
            			PreparedStatement pstmt=con.prepareStatement("select * from products where product_category='Fashion & Beauty'");
            ...
            <div class="row align-items-center product-slider product-slider-4">
                <%
                    try {
            			...
            			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/productbazaar","root","root");
            			System.out.println("connection");
            			PreparedStatement pstmt=con.prepareStatement("select * from products where product_category='Gadgets & Accessories'");
    ...
    <!-- Gadgets & Accessories End -->
    
    <!-- Electronics & Accessories Start -->
    <div class="recent-product product">
        <div class="container-fluid">
            <div class="section-header">
            ...
            <div class="row align-items-center product-slider product-slider-4">
                <%
                    try {
            			...
            			con=DriverManager.getConnection("jdbc:mysql://localhost:3306/productbazaar","root","root");
            			System.out.println("connection");
            			PreparedStatement pstmt=con.prepareStatement("select * from products where product_category='Electronics & Accessories'");
