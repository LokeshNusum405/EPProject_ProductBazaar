...
int product_id = (int)(Math.random()*999999)+1;
...
try{
	...
	pstmt.setString(6,amazon);
	pstmt.setInt(7,amazon_cost);
	pstmt.setString(8,flipkart);
	pstmt.setInt(9,flipkart_cost);
	pstmt.setString(10,shopclues);
	pstmt.setInt(11,shopclues_cost);
	pstmt.setString(12,ebay);
	pstmt.setInt(13,ebay_cost);
	
	pstmt.setBinaryStream(14, (InputStream)fis1, (int)(imagefile1.length()));
	pstmt.setBinaryStream(15, (InputStream)fis2, (int)(imagefile2.length()));
	pstmt.setBinaryStream(16, (InputStream)fis3, (int)(imagefile3.length()));
	pstmt.setBinaryStream(17, (InputStream)fis4, (int)(imagefile4.length()));
	pstmt.setBinaryStream(18, (InputStream)fis5, (int)(imagefile5.length()));
	pstmt.setBinaryStream(19, (InputStream)fis6, (int)(imagefile6.length()));
	pstmt.setBinaryStream(20, (InputStream)fis7, (int)(imagefile7.length()));
